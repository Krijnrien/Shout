...
class ChatMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new SizeTransition(
      ...
      axisAlignment: 0.0,
      child: new Container(margin: const EdgeInsets.symmetric(vertical: 10.0),
        child: new Row(
          ...
          new Expanded(child: new Column(
            ...
            new Container(margin: const EdgeInsets.only(top: 5.0),
              child: snapshot.value['imageUrl'] != null ? new Image.network(
                  snapshot.value['imageUrl'], width: 250.0) : new Text(
                  snapshot.value['text']),
            ),
          ],
          ),
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text("Fontys geo chat"),
          elevation: Theme
              .of(context)
